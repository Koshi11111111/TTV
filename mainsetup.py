...
twitch_miner = TwitchChannelPointsMiner(
    username="koshi9012",
    password="Bartek901221@!@!",           # If no password will be provided, the script will ask interactively
